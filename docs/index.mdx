...
Jira MCP is a Model Context Protocol server that allows AI assistants to interact with your Jira instance. Ask questions about tickets, create issues, manage sprints, and more through natural language.

## How it works

<Steps>
<Step title="Prompt your AI assistant">
  You enter questions or prompts to an LLM client such as Claude Desktop, Cursor, Windsurf, or ChatGPT.
</Step>
