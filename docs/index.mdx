...
<Note>
**Safe for corporate environments.** This MCP server runs completely locally on your machine using the [jira-cli](https://github.com/ankitpokhrel/jira-cli) command line tool. No data is sent to third-party services. If your organization approves the use of jira-cli, on a technical level this MCP server is safe to use. _If in doubt, check with your IT department._
</Note>
